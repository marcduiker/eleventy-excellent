...
{% image "./src/assets/images/blog/2019/37.1.azfunctionupdates_diagram_cover.png", "AzureFunctionsUpdate TwitterBot architecture" %}
...
{% image "./src/assets/images/blog/2019/37.2.azfunctionupdates_diagram.png", "Azure Functions Updates component diagram" %}
...
{% image "./src/assets/images/blog/2019/37.3.alert-configuration.png", "Alert configuration" %}
...
{% image "./src/assets/images/blog/2019/37.4.configure-signal-logic.png", "Signal selection" %}
...
{% image "./src/assets/images/blog/2019/37.5.application-map.png", "Application map" %}
...
{% image "./src/assets/images/blog/2019/37.6.dependency-reponse-time.png", "Average duration HTTP APIs" %}
...
{% image "./src/assets/images/blog/2019/37.7.durationdistribution-httpapis.png", "Duration distribution for HTTP calls to GitHub and Twitter" %}
...
{% image "./src/assets/images/blog/2019/37.8.durationdistribution-orchestration.png", "Duration distribution for ReleaseUpdateOrchestration" %}
...
{% image "./src/assets/images/blog/2019/37.9.cost-analysis.png", "Cost analysis" %}
