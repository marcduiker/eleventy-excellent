...
{% image "./src/assets/images/blog/2016/21.add_feature_script.png", "Add-Feature PowerShell function" %}

In my [previous post](/articles/hands-on-with-sitecore-helix-using-powershell-add-module) I 
...
The `add-helixmodule.ps1` script is where all the action happens. The file is [included in my Habitat fork](https://github.com/marcduiker/Habitat/blob/master/scripts/add-helixmodule.ps1) and is also available as a gist which is shown inline below.
