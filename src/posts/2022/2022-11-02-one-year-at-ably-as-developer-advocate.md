...
<!-- {% image "./src/assets/images/blog/2022/63.3.console_chat.gif", "Console Chat" %} -->
...
<!-- {% image "./src/assets/images/blog/2022/63.4.serverless-websockets-play.gif", "Serverless WebSockets Quest" %} -->
...
<!-- {% image "./src/assets/images/blog/2022/63.5.collaborative-pixelart-drawing.gif", "Collaborative Pixelart Drawing" %} -->
...
<!-- {% image "./src/assets/images/blog/2022/63.6.pizza-workflow.gif", "Serverless Pizza Workflow Visualizer" %} -->
...
<!-- {% image "./src/assets/images/blog/2022/63.8.vscode-ably-applist.gif", "List Ably Apps" %} -->
...
<!-- {% image "./src/assets/images/blog/2022/63.9.ably-cli.png", "Ably CLI: List Ably Apps" %} -->
...
<!-- {% image "./src/assets/images/blog/2022/63.10.dotnetdaysro_speaking.jpg", "Speaking at dotnetdays Romania" %} -->
