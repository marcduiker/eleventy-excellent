...
{% image "./src/assets/images/blog/2013/63.1.DevRel_team_marc_selected.png", "Ably DevRel team" %}
...
{% image "./src/assets/images/blog/2013/63.7.ably-control-api-action.png", "Ably Control API GitHub Action" %}
